...
\begin{table}[h!]
  ...
  \begin{tabular}{|c|c|c|c|c|}
      ...
      \textit{\textbf{Rata-Rata}} & \begin{tabular}[c]{@{}l@{}}0,752317\end{tabular} & \begin{tabular}[c]{@{}l@{}}0,712083\end{tabular} & \begin{tabular}[c]{@{}l@{}}0,892802\end{tabular} & \begin{tabular}[c]{@{}l@{}}0,930273\end{tabular}\\ \hline
  \end{tabular}
  \end{center}
\end{table}
...
Dari pengujian keempat, didapatkan hasil bahwa model Swin Transformer V1 \linebreak parameter 1 gagal dalam melakukan re-identifikasi, 
