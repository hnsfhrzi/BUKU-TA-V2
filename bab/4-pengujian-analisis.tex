...
Pengujian keenam menggunakan sebuah gambar kueri ke-29 dengan objek mobil taksi berwarna biru tua dan oranye, dengan sebagian 
badan mobil tertutup oleh objek lain. Gambar kueri beserta hasil GradCam dapat dilihat pada gambar 
...
\begin{figure}[h!]
  ...
  \begin{subfigure}{.5\textwidth}
    ...
    \caption{Gambar Kueri ke-29}
    \label{gambarkuerinomorduasembilan}
  \end{subfigure}%
  \begin{subfigure}{.5\textwidth}
    \centering
    \includegraphics[width=.4\linewidth]{gambar/GradCamQue29_1060.jpg}
    \caption{GradCam Gambar Kueri ke-29}
    \label{gradcamgambarkuerinomorduasembilan}
  \end{subfigure}
  \caption{Gambar Kueri untuk Pengujian Keenam}
  \label{fig:gambarkueriuntukpengujiankeenam}
\end{figure}

Gambar galeri yang dicari pada pengujian keenam merupakan gambar dengan objek mobil taksi berwarna biru tua 
dan oranye yang sesuai dengan gambar \ref{fig:gambarkueriuntukpengujiankeenam} dengan sudut pengambilan yang berbeda. 
Gambar galeri beserta hasil GradCam dapat dilihat pada gambar \ref{fig:gambargaleriuntukpengujiankeenam}.
...
\begin{figure}[h!]
  ...
  \end{subfigure}
  \caption{Gambar Galeri yang Dicari untuk Pengujian Keenam}
  \label{fig:gambargaleriuntukpengujiankeenam}
\end{figure}

Dengan memasukkan gambar kueri ke-29 ke dalam model Swin Transformer V1 parameter 1 dengan iterasi 3, didapatkan hasil 
...
Hasil pengujian yang didapat ketika memasukkan gambar kueri ke-29 ke dalam model Swin Transformer V2 parameter 1 dengan 
...
Dari memasukkan gambar kueri ke-29 ke dalam model Swin Transformer V1 parameter 2 dengan iterasi 2, didapatkan hasil 
...
Hasil pengujian dari model Swin Transformer V2 parameter 2 dengan iterasi 1 menggunakan gambar kueri ke-29 dapat 
...
re-identifikasi ketika diberikan gambar kueri ke-29. Hal ini dapat dilihat dari hasil peringkat sepuluh teratas dari setiap 
model tidak menunjukan adanya gambar galeri (gambar \ref{fig:gambargaleriuntukpengujiankeenam}) pada daftar peringkat yang 
ada. Hasil pengujian ini memperlihatkan bahwa jika gambar kueri dengan objek yang setengah utuh ingin diidentifikasi 
ulang, model re-identifikasi kesulitan untuk mengenali objek tersebut.

\subsection{Pengujian Ketujuh}

Pengujian ketujuh menggunakan sebuah gambar kueri ke-70 dengan objek mobil suv \linebreak berwarna hitam. Gambar kueri 
...
\begin{figure}[h!]
  ...
  \begin{subfigure}{.5\textwidth}
    ...
    \caption{Gambar Kueri ke-70}
    \label{gambarkuerinomortujuhpuluh}
  \end{subfigure}%
  \begin{subfigure}{.5\textwidth}
    \centering
    \includegraphics[width=.4\linewidth]{gambar/GradCamQue70_114.jpg}
    \caption{GradCam Gambar Kueri ke-70}
    \label{gradcamgambarkuerinomortujuhpuluh}
  \end{subfigure}
  \caption{Gambar Kueri untuk Pengujian Ketujuh}
  \label{fig:gambarkueriuntukpengujianketujuh}
\end{figure}

Gambar galeri yang dicari pada pengujian ketujuh merupakan gambar dengan objek mobil suv berwarna hitam 
yang sesuai dengan gambar \ref{fig:gambarkueriuntukpengujianketujuh} dengan sudut pengambilan yang berbeda. 
Gambar galeri beserta hasil GradCam dapat dilihat pada gambar \ref{fig:gambargaleriuntukpengujianketujuh}.
...
\begin{figure}[h!]
  ...
  \end{subfigure}
  \caption{Gambar Galeri yang Dicari untuk Pengujian Ketujuh}
  \label{fig:gambargaleriuntukpengujianketujuh}
\end{figure}

Dengan memasukkan gambar kueri ke-70 ke dalam model Swin Transformer V1 parameter 1 dengan iterasi 3, didapatkan hasil 
...
Hasil pengujian yang didapat ketika memasukkan gambar kueri ke-70 ke dalam model Swin Transformer V2 parameter 1 dengan 
...
Dari memasukkan gambar kueri ke-70 ke dalam model Swin Transformer V1 parameter 2 dengan iterasi 2, didapatkan hasil 
...
Hasil pengujian dari model Swin Transformer V2 parameter 2 dengan iterasi 1 menggunakan gambar kueri ke-70 dapat 
...
re-identifikasi ketika diberikan gambar kueri ke-70. Hal ini dapat dilihat dari hasil peringkat sepuluh teratas dari setiap 
model tidak menunjukan adanya gambar galeri (gambar \ref{fig:gambargaleriuntukpengujianketujuh}) pada daftar peringkat yang 
ada. Hasil pengujian ini memperlihatkan bahwa jika gambar kueri dengan resolusi yang terlalu kecil hingga objek terlalu sulit 
