...
Perbandingan setiap jenis model beserta iterasinya dapat dilihat pada tabel 4.9. 
...
\begin{table}[h!]
  ...
  \begin{tabular}{|c|c|c|c|c|c|}
      ...
      & \begin{tabular}[c]{@{}l@{}}Iterasi 3\end{tabular} & \begin{tabular}[c]{@{}l@{}}0.715753\end{tabular} & \begin{tabular}[c]{@{}l@{}}0.674493\end{tabular} & \begin{tabular}[c]{@{}l@{}}0.854856\end{tabular} & \begin{tabular}[c]{@{}l@{}}0.897901\end{tabular}\\ \hline
      \multirow{3}{*}{\textbf{Swin T. V1 Parameter 2}} & \begin{tabular}[c]{@{}l@{}}Iterasi 1\end{tabular} & \begin{tabular}[c]{@{}l@{}}0.745984\end{tabular} & \begin{tabular}[c]{@{}l@{}}0.704731\end{tabular} & \begin{tabular}[c]{@{}l@{}}0.887229\end{tabular} & \begin{tabular}[c]{@{}l@{}}0.926361\end{tabular}\\
      & \begin{tabular}[c]{@{}l@{}}\textbf{Iterasi 2}\end{tabular} & \begin{tabular}[c]{@{}l@{}}\textbf{0.751921}\end{tabular} & \begin{tabular}[c]{@{}l@{}}\textbf{0.711135}\end{tabular} & \begin{tabular}[c]{@{}l@{}}\textbf{0.892209}\end{tabular} & \begin{tabular}[c]{@{}l@{}}0.933120\end{tabular}\\
      & \begin{tabular}[c]{@{}l@{}}Iterasi 3\end{tabular} & \begin{tabular}[c]{@{}l@{}}0.750978\end{tabular} & \begin{tabular}[c]{@{}l@{}}0.709712\end{tabular} & \begin{tabular}[c]{@{}l@{}}0.891498\end{tabular} & \begin{tabular}[c]{@{}l@{}}\textbf{0.934899}\end{tabular}\\ \hline
      \multirow{3}{*}{\textbf{Swin T. V2 Parameter 2}} & \begin{tabular}[c]{@{}l@{}}Iterasi 1\end{tabular} & \begin{tabular}[c]{@{}l@{}}0.750173\end{tabular} & \begin{tabular}[c]{@{}l@{}}0.710423\end{tabular} & \begin{tabular}[c]{@{}l@{}}0.890786\end{tabular} & \begin{tabular}[c]{@{}l@{}}0.929918\end{tabular}\\
      & \begin{tabular}[c]{@{}l@{}}Iterasi 2\end{tabular} & \begin{tabular}[c]{@{}l@{}}0.750367\end{tabular} & \begin{tabular}[c]{@{}l@{}}0.710068\end{tabular} & \begin{tabular}[c]{@{}l@{}}0.889363\end{tabular} & \begin{tabular}[c]{@{}l@{}}0.925294\end{tabular}\\
      & \begin{tabular}[c]{@{}l@{}}Iterasi 3\end{tabular} & \begin{tabular}[c]{@{}l@{}}0.751293\end{tabular} & \begin{tabular}[c]{@{}l@{}}0.711135\end{tabular} & \begin{tabular}[c]{@{}l@{}}0.889719\end{tabular} & \begin{tabular}[c]{@{}l@{}}0.930985\end{tabular}\\ \hline
    \end{tabular}
  \end{center}
\end{table}

Dari perbandingan tersebut dapat terlihat bahwa model Swin Transformer V1 parameter 2 pada iterasi kedua menjadi model 
dengan nilai mAP, rank@1, dan rank@5 tertinggi dari seluruh model yang telah dibuat pada penelitian ini.

\section{Skenario Pengujian}
\label{sec:skenariopengujian}

Pengujian dilakukan menggunakan setiap jenis model re-identifikasi mobil dengan iterasi terbaik pada masing-masing modelnya. Penentuan 
jenis model re-identifikasi dengan iterasi terbaik didasarkan dari nilai mAP dan rank@1 yang didapat lebih tinggi dari 
iterasi lainnya pada jenis model yang sama. Dari hasil \emph{training} dan \emph{validation}, maka model dapat dilakukan \emph{testing} 
menggunakan data \emph{query} dan \emph{gallery} yang telah tersedia dari dataset VRIC. Model re-identifikasi mobil yang digunakan 
untuk pengujian dapat dilihat pada tabel 4.10.
...
\begin{table}[h!]
  ...
  \begin{tabular}{|c|c|c|c|}
      ...
      \begin{tabular}[c]{@{}l@{}}Swin T. V1 Parameter 2\end{tabular} & \begin{tabular}[c]{@{}l@{}}Iterasi 2\end{tabular} & \begin{tabular}[c]{@{}l@{}}0.751921\end{tabular} & \begin{tabular}[c]{@{}l@{}}0.711135\end{tabular}\\ \hline
      \begin{tabular}[c]{@{}l@{}}Swin T. V2 Parameter 2\end{tabular} & \begin{tabular}[c]{@{}l@{}}Iterasi 3\end{tabular} & \begin{tabular}[c]{@{}l@{}}0.751293\end{tabular} & \begin{tabular}[c]{@{}l@{}}0.711135\end{tabular}\\ \hline
  \end{tabular}
  \end{center}
\end{table}
