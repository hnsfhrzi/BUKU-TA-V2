...
perlu dilakukan perubahan nama file sesuai dengan label ID dan label kameranya. program yang 
dibuat untuk merubah nama data dalam dataset dapat dilihat pada program \ref{lst:renamedataset}.\\
