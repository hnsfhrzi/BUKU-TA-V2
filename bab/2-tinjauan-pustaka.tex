...
\begin{figure}[ht]
  ...
  % Keterangan gambar yang diinputkan
  \caption{Perbandingan Berbagai Hasil Pendekatan Perhitungan Bias Posisi}
  % Label referensi dari gambar yang diinputkan
...
dapat dilihat pada gambar 2.10.\parencite{Kanaci2018}
...
Contoh tangkapan gambar lalu lintas dapat dilihat pada gambar 2.11.\parencite{Kanaci2018}
...
Seperti yang terlihat di gambar 2.12, rata-rata resolusi gambar dari 60.430 \emph{bounding-box} kendaraan adalah \begin{math}69,8 \times 107,5\end{math} piksel pada 
...
sampel jarak jauh antara gambar \emph{probe} dan \emph{gallery}. \parencite{Kanaci2018} Pembagian data untuk kebutuhan \emph{training} dan \emph{testing} dapat dilihat pada gambar 2.13.
