...
% \section{\emph{Evaluation Metrics}}
% \label{sec:evaluationmetrics}

% Pada \emph{machine learning}, \emph{evaluation metrics} digunakan untuk mengukur kualitas model dari statistik atau \emph{machine learning}. Saat mengevaluasi model 
% \emph{machine learning}, penting untuk menilai kemampuan prediksi, kemampuan generalisasi, dan kualitas keseluruhan. \emph{Evaliation metrics} memberikan kriteria 
% objektif untuk mengukur aspek-aspek tersebut. Pemilihan jenis \emph{evaluation metrics} bergantung pada domain masalah tertentu, jenis data, dan hasil yang 
% diinginkan \parencite{Srivastava2023}.

% \subsection{\emph{Mean Average Precision}}

% \emph{Mean Average Precision} atau mAP merupakan salah satu metrik populer yang digunakan untuk mengukur performa dari model yang melakukan tugas 
% visi komputer, seperti \emph{object detection}, \emph{information retrieval}, dan re-identifikasi. mAP merupakan 
% rata-rata dari AP atau \emph{average precision}. AP merupakan salah satu untuk meringkas kurva presisi-recall 
% menjadi 

% \begin{equation}
%   \label{eq:hukumpertamanewton}
%   mAP = \frac{1}{\mathbf{Q}} \sum_{q=1}^Q AP(q)
% \end{equation}
